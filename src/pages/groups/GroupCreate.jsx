...
const CreateGroup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await instance.post(API.groups, formData);
      toast.success("Group created successfully!", { id: toastId });
      navigate("/groups"); // Redirect to the groups list page on success
    } catch (err) {
  ...
  if(!can("Groups", "create")) {
    return <AccessDenied message={"You do not have permission to create groups."} />;
  }
